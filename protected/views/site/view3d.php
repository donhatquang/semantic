...
<link rel="stylesheet" type="text/css"
      href="<?php echo Yii::app()->request->baseUrl; ?>/ref/tooltipster-master/css/tooltipster.css"/>
<!-- semantic -->
...
<script>
    ...
    $(function () {
        ...
        //----->
        //SCREEN SHOT
        //DATA IS THE 3D MODEL BASE 64 CODE
...
<div align="center">
    ...
    <button class="button large default" onclick="window.location = '?r=semantic/index&image=images/model/flight.jpg';">
        SEMANTIC
    </button>
