...
//////////////////////////////////////////////////////////////////////////////////////////////
	...
	window._skel_config = {
		prefix: Semantic_config.css_host,
		resetCSS: true,
		pollOnce: true,
		containers: 'fluid',
		grid: { gutters: 4 },
			...
			// Settings
				settings: {
					...
					// Desktop only
						...
						introDelay:			300,		// Delay (in ms) before showing the reel
						introSpeed:			500,		// Speed (in ms) at which to fade in reel
						itemHeight:			230,		// Height (in px) of items
						itemWidth:			300,		// Default width (in px) of width
						marginBottom:		0,			// Margin (in px) to preserve at the bottom of the viewport
						...
						paddingColor:		'#ccc',		// Padding color
						...
						scrollZoneDelay:	10,			// Time (in ms) to wait between scrolls when the cursor is in a scroll zone
						scrollZoneWidth:	40,			// Width of scroll zones
						thumbDelay:			500,		// Delay (in ms) before showing thumbnails
						thumbDelaySpread:	600,		// Spread (in ms) to randomly stagger thumbnails (0 = don't stagger)
						thumbSpeed:			250,		// Speed (in ms) at which to fade in thumbnails
